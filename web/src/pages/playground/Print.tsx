...
const T = {
  ...
  fr: {
    ...
    intro:
      "Fabriquez de vrais puzzles à tenir en main : posez des plateaux, déplacez-les librement sur la page, ajustez leur taille par le coin, puis imprimez en recto verso et découpez le long des traits. Au dos de chaque pièce figurent son numéro et le code du jeu : de quoi retrier un lot mélangé. Les numéros ne dévoilent jamais la solution.",
    addCustom: "Ajouter",
    sizeLabel: "Taille",
    addPage: "+ Page",
    sheets: (n: number) => (n === 1 ? "1 feuille" : `${n} feuilles`),
    duplexHint:
      "Imprimez à 100 %, en recto verso, avec retournement sur le bord long. Rectos et versos s'alternent pour que le numéro de chaque pièce tombe bien au dos.",
    dragHint:
      "Glissez les plateaux pour les déplacer, même d'une page à l'autre ; tirez le coin bleu pour les redimensionner. Cliquez pour sélectionner.",
    print: "Imprimer",
    empty: "Ajoutez un plateau pour commencer.",
    colors: "Couleurs",
    duplicate: "Dupliquer sur la page suivante",
    newSeed: "Relancer",
    set: "Jeu",
    answerKey: "Solution :",
    cutHint: "découpez le long des traits",
    front: "recto",
