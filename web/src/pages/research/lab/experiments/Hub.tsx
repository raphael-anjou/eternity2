...
const T = {
  en: {
    ...
    title: "Experiments",
    intro:
      "The named search experiments built to push the score. Some are our own ideas; some are honest reimplementations of a known technique, run to measure exactly what it buys. Each has its idea, its result, and the questions it left open. The best reaches 463 of 480 matched edges; the community's best on the same puzzle is 469. Methods and boards are here in full.",
    logCta: "Browse the full experiments log — every attempt, including the dead ends →",
    soon: "In preparation",
    scoreSuffix: "/ 480",
    liveBadge: "live demo",
    families: {
  ...
  fr: {
    ...
    title: "Expériences",
    intro:
      "Les expériences de recherche nommées, conçues pour pousser le score. Certaines sont nos propres idées ; d'autres sont des réimplémentations honnêtes d'une technique connue, menées pour mesurer exactement ce qu'elle apporte. Chacune a son idée, son résultat et les questions qu'elle a laissées. La meilleure atteint 463 bords appariés sur 480 ; le meilleur de la communauté sur le même puzzle est 469. Méthodes et plateaux sont ici en entier.",
    logCta: "Parcourir le journal complet des expériences — chaque tentative, impasses comprises →",
    soon: "En préparation",
    scoreSuffix: "/ 480",
  ...
  return (
    <div className="space-y-10">
      <div>
        ...
        <LocalizedLink
          to="/research/lab/experiments/log"
...
export const meta = pageMeta("experiments");
