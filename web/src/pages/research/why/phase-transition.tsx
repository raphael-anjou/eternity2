...
const T = {
  en: {
    ...
    why2: "It also matches what you can measure. On the Algorithms page, the work a solver does on generated puzzles shoots up as the color count nears this range, for boards far smaller than the real one. The full 16x16 sits well past the point where that curve has gone vertical.",
  ...
  fr: {
    ...
    why2: "Cela correspond aussi à ce qu'on peut mesurer. Sur la page Algorithmes, le travail d'un solveur sur des puzzles générés grimpe en flèche à l'approche de cette plage, pour des plateaux bien plus petits que le vrai. Le 16x16 complet est largement au-delà du point où cette courbe est devenue verticale.",
