...
const T = {
  en: {
    ...
    reproBody: "Computed exactly from the official set; reproduces identically every run — for h(1), h(2) and λ_H. The deeper h(3), h(4) and the limit come from a heavier offline sweep, labelled as such.",
  ...
  fr: {
    ...
    reproBody: "Calculé exactement à partir du jeu officiel ; se reproduit à l'identique à chaque exécution — pour h(1), h(2) et λ_H. Les h(3), h(4) plus profonds et la limite viennent d'un balayage hors ligne plus lourd, étiquetés comme tels.",
