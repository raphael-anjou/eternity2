...
const T = {
  en: {
    ...
    bigger:
      "The same accounting works if you place 2×2 or 3×3 tiles instead of single pieces: treat a tile as a composite cell with its own match probability and remaining supply. The funnel keeps its shape; the depth axis rescales. Estimating the node count for a chosen path and tile size is exactly the kind of thing this theory is for — and a natural next feature for the search-path playground.",
  ...
  fr: {
    ...
    bigger:
      "Le même calcul tient si l'on pose des tuiles 2×2 ou 3×3 au lieu de pièces seules : traitez une tuile comme une case composite avec sa propre probabilité d'accord et son stock restant. L'entonnoir garde sa forme ; l'axe de profondeur se redimensionne. Estimer le nombre de nœuds pour un chemin et une taille de tuile donnés est exactement l'usage de cette théorie — et une suite naturelle pour le terrain de jeu des ordres de parcours.",
