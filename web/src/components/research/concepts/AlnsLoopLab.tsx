...
const T = {
  en: {
    ...
    ops: { patch: "Random patch", rows: "Worst row", worst: "Worst region" } satisfies Record<Op, string>,
    score: "score",
    best: "best",
  ...
  fr: {
    ...
    ops: { patch: "Patch aléatoire", rows: "Pire rangée", worst: "Pire région" } satisfies Record<Op, string>,
    score: "score",
    best: "meilleur",
  ...
  es: {
    ...
    ops: { patch: "Parche aleatorio", rows: "Peor fila", worst: "Peor región" } satisfies Record<Op, string>,
    score: "puntuación",
    best: "mejor",
