...
export const RESEARCH_NODES: ResearchNode[] = [
  ...
  N(
    ...
    ["/research/why/rigidity-wall", "/research/why/mismatch-geometry", "/research/lab/experiments/keyring"],
  ),
  N(
  ...
  N(
    ...
    ["/research/why/entropy-area-law", "/research/lab/experiments/keyring"],
  ),
  N(
    "/research/why/no-forced-moves",
    "why",
  ...
  N(
    ...
    ["/research/why/no-forced-moves", "/research/lab/experiments/prior"],
  ),
  N(
  ...
  N(
    ...
    ["/research/why/rigidity-wall", "/research/lab/experiments/keyring"],
  ),
  N(
  ...
  N(
    ...
    ["/research/lab/experiments/cloister", "/research/lab/experiments/bandsaw"],
  ),
  N(
    ...
    ["/research/lab/experiments/staged", "/research/why/entropy-area-law"],
  ),
  N(
    ...
    ["/research/lab/experiments/replay", "/research/lab/experiments/prior"],
  ),
  N(
    ...
    ["/research/lab/experiments/ladder", "/research/records", "/research/why/rigidity-wall"],
  ),
  N(
  ...
  N(
    ...
    ["/research/lab/experiments", "/research/why/rigidity-wall"],
  ),
  N(
...
export const KIND_LABEL: Record<LinkKind, { en: string; fr: string }> = {
  ...
  invention: { en: "Experiment", fr: "Expérience" },
