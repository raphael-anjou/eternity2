...
description: >-
  ...
  cartografiado.
metaDescription: "La frontera abierta de Eternity II en un tablero: la brecha de 470 a 480, la marca estricta de cinco pistas más allá de 465, el 10x10 sin pistas set_2 de Owen sin resolver, cruzar una cuenca de rigidez, el muro de memoria del meet-in-the-middle y un eje de diversidad tras el parallel tempering."
kind: reference
order: 35
updated: 2026-07-21
topics: []
...
## El objetivo estricto de cinco pistas, de 465 a 466

<Callout kind="open" title="¿Puede un tablero que honra las cinco pistas oficiales superar 465?">
  ...
  El mejor tablero que respeta las cinco colocaciones es 465.
</Callout>
...
**Probado, y dónde se detuvo.** El 465 es la marca vigente de la línea estricta en
la página de [puzles con pistas](/research/build/clue-puzzles), alcanzada en
agosto de 2026 por la [flota distribuida](/research/community/five-clue-fleet) de
la comunidad, que sigue en marcha y cuyo objetivo declarado es justo este. Las
construcciones estrictas y re-compresiones del proyecto alcanzan la clase de los
460 sin pasarla, como se traza en el
[mapa de muros y métodos](/research/why/walls-and-methods).

**Etiqueta.** Difícil, bien cartografiado, pero un paso más corto que la brecha de
470 a 480: de 465 a 466 es una sola arista, en una línea donde la región alcanzable
es más ceñida y por tanto más fácil de razonar que el record abierto. Es además
el único problema abierto de esta página con una búsqueda en marcha, y abierta,
detrás.
