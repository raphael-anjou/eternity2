...
every record, theory, tool and honest dead end — traces back to someone who
...
benchmark puzzles the community still races on, and the closed-form
...
([msg 15](https://groups.io/g/eternity2/message/15)) — and greeted the 2005
press claims with "So we can conclude, the end of the universe is in several
years." ([msg 34](https://groups.io/g/eternity2/message/34)). He kept the
list honest for two decades, from exact-cover conversions in 2007 to the
nodes-per-watt hardware ledger of the 2010s.
...
([msg 3511](https://groups.io/g/eternity2/message/3511)) — open-sourced his
solver ([msg 3716](https://groups.io/g/eternity2/message/3716)), and left
...
benchmark boards ([msg 1610](https://groups.io/g/eternity2/message/1610))
and was the community's best hand-designer of fill orders — his duel with
...
([msg 7755](https://groups.io/g/eternity2/message/7755)) and framed the
post-contest era's honest goal — "beat 468 matching edges"
...
caught the flaws that made others' results solid — kubzpa's paper shipped
its corrected second version after his pass
...
which this site ports. In 2017 he solved Owen's hint-free 10×10 — ~180
...
[msg 9023](https://groups.io/g/eternity2/message/9023)), followed by the
2017 MILP and Max-Clique work
...
Arrived in 2012 and reset the speed standard in 2014 with a 114.5 million
...
transfer fee — "I can pay for the first 5 years"
...
A speed veteran of the 2014 era — his Forth solver ran at 80–90 million
...
and improved on the 2008 SAT benchmark results
...
broke 558 million placements per second in 2009 and became the group's
...
founder of the five-clue ladder and the invalid-combination mining programme
