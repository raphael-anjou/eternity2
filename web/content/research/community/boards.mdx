...
description: >-
  ...
  record to 465, and this project's own boards: who found each one, when, and
  what makes it structurally interesting. Every bundled board opens in the viewer.
metaDescription: "The notable Eternity II boards: Verhaard's prize 467, the Blackwood-solver line from 468 through McGavin's 469 to the 470/480 ceiling, and the strict five-clue record from Gauthier's 460 to the 465 of Riotte's fleet. Who found each and when, and every bundled board opens in the viewer."
kind: basin
order: 40
updated: 2026-07-02
topics: []
sources:
  ...
  - label: "Riotte's 464, the strict five-clue record of July 2026 (groups.io)"
...
## The strict five-clue line: from Gauthier's 460 to the fleet's 465
...
Two months later the line moved again, and the shape of the effort changed with
it. Riotte opened a distributed search to the community, and by the time it was
announced on 30 August 2026 it had **465/480 (15 broken edges)** in hand, with
eleven distinct boards at that score
([the fleet's announcement thread](https://groups.io/g/eternity2/topic/120997660)).
Many more have been credited since, across several contributors' machines, so
465 is now a populated line rather than a single board. It is worth reading that
count carefully: Carlos Fernandez took the first two 465s and showed they belong
to one local family, where exchanging two groups of border pieces, rotating a
third group and swapping a pair generates 32 boards at the same score. Many
boards at 465 is not the same statement as many independent ways to reach 465.
The boards live in the fleet's own
[public library](https://eternity-board-library.pages.dev/); this wiki bundles
the July 464 line below, not the 465s. How the fleet works, and how to join it,
is on [its own page](/research/community/five-clue-fleet).
...
is playing the exact game the designers set. The 465 stands fifteen edges below
