...
metaDescription: "The lab's editorial standard: how Eternity II research goes from unpublished work to a published page, classified by contribution, tier, and reproducibility."
kind: page
status: report
