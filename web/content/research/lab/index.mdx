...
metaDescription: "The wiki's open notebook: original Eternity II structural findings and named search experiments, each credited to the researcher who ran it and reproducible from source. Original ideas and faithful reimplementations of community techniques, published to one editorial standard and open for your own."
kind: page
updated: 2026-07-21
---
...
- **[The experiments](/research/lab/experiments)** is the full gallery: every
  named search and structural finding, filterable by outcome and researcher.
  Start here to browse.
- **[Which wall stops which method](/research/why/walls-and-methods)** reads the
  gallery as one picture: each experiment against the wall it attacks and the
  score where it stopped.
- **[How the lab publishes](/research/lab/experiments/methodology)** is the
  shared editorial standard every page here meets, so you know what each label
  on a result means.
- **[Contribute](/research/contribute)** is how to add your own finding, credited
