...
description: >-
  ...
  460, and this project's own boards — who found each one, when, and what
  makes it structurally interesting. Every bundled board opens in the viewer.
kind: basin
order: 30
updated: 2026-07-02
topics: [records]
sources:
  ...
  - label: "msg 11074 — Gauthier's strict five-clue 460"
...
distributed *eii* solver — released to volunteers in September 2008 with the
words "I am stuck" ([msg 5940](https://groups.io/g/eternity2/message/5940)) —
had found 467/480 more than 40 times by different users by the time he
...
Days later Blackwood open-sourced the solver that found it
([msg 10037](https://groups.io/g/eternity2/message/10037)) — the code every
board below this point traces back to.
...
— Peter McGavin, running Blackwood's freshly published solver
...
is locally flawless — the damage swept up against the edge the search
...
### The 469 wave (November 2020)

Bucas ported Blackwood's algorithm to C, roughly doubling its speed
([msg 10065](https://groups.io/g/eternity2/message/10065)), and 469s started
arriving in a stream: boards a through g over three weeks
...
Blackwood closed his own arc with a two-line message: a viewer URL and a
piece list, 470/480, 10 breaks
...
official spot and none of the four optional clue pieces at theirs — checked
board by board in the community
([msg 10554](https://groups.io/g/eternity2/message/10554)). Under the
...
boards live and shows the band — and shows this project's boards exhibiting
the same band, mirrored.
...
## The strict five-clue line: Gauthier's 460
...
(David Barr) — and stopped at **Bruno Gauthier's 460**, "made with my own
...
is playing the exact game the designers set. The 460 stands ten edges below
the one-clue ceiling, and that gap is itself a datum.

## This project's boards

This site's own experiments produced four boards worth keeping — honestly
several steps below the community line, and documented end to end. Each links
...
[the PALIMPSEST experiment](/research/lab/experiments/palimpsest).
...
see [KEYRING](/research/lab/experiments/keyring). Its mismatches band in the
bottom rows, the mirror image of McGavin's 469 — the scan-order fingerprint
explained in [Where the mismatches live](/research/why/mismatch-geometry).
...
[PRIOR](/research/lab/experiments/prior).

<RecordBoard id="v155-prior-460" />

### GAUNTLET — 458

The same beam search run across nine scan orders so it lands in different
regions of board space; the zigzag order found this brand-new 458 — see
