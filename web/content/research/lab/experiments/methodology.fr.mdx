...
metaDescription: "Le standard éditorial du labo : comment un travail de recherche sur Eternity II passe d'un état non publié à une page publiée. Trois axes décrivent chaque page : la contribution (solveur, analyse, théorie, résultat négatif...), le niveau de relecture, et la rigueur de son affirmation."
kind: page
status: report
order: 5
...
contribution](/research/lab/experiments/by-contribution) regroupe les pages selon
...
entière](/research/lab/experiments/by-contribution/negative) ont chacune leur
propre étagère.
