...
is an exact finisher on the bottom rows that minimizes mismatches, and
crucially it chooses the bottom border last, against whatever pieces are
...
well below the records, and that gap is the finding: it measures honestly how
