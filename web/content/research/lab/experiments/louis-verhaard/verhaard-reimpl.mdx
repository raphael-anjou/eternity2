...
description: >-
  ...
  under the 2×2-tiling metric; on the real five-clue puzzle it reaches 438 of
  480, single core.
metaDescription: "A from-scratch reimplementation of Verhaard's eii method: set-composition swap-annealing under the 2×2-tiling metric, reaching 438/480 on the real five-clue puzzle, single core. Numeric constants recovered byte-exact from eii.exe; the run is committed and rerunnable, so 438 is checkable."
kind: experiment
