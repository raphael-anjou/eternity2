...
metaDescription: "Verhaard's eii, the engine behind the 467 and only Eternity II prize: forward pruning, comb-search orders, a Markov-tuned slip schedule, and why it won't run here."
kind: page
...
<Callout kind="note" title="Whose work this is">
  ...
  filed under Raphaël's section because that code is not Verhaard's.
</Callout>
