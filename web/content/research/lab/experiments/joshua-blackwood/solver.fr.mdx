...
metaDescription: "Le backtracker C# record de Blackwood décodé via Jef Bucas, puis exécuté sur un M1 : 248/256 sans contrainte, mais cale vers 45/256 dès les 5 indices épinglés."
kind: experiment
