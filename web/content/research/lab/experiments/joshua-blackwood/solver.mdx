...
metaDescription: "Blackwood's record 470-class C# backtracker, decoded via Jef Bucas and run single-core on an Apple M1: as published it reaches 248/256 pieces (454/480 edges), yet stalls near 45/256 once the five official clues are pinned. Inside: the colour-quota schedule and why hand-tuning proved near-optimal."
kind: experiment
...
<Figure caption="The two pattern sets behind the best-scoring 470-class runs, mapped onto the board: the three privileged motifs cluster in the region the scan fills first. Figures by Jef Bucas (wrapper_blackwood), reproduced with permission.">
  <div className="grid gap-3 sm:grid-cols-2">
    <img src={patternsA} alt="First prioritized pattern set mapped on the 16×16 board" loading="lazy" className="rounded-lg border" />
    <img src={patternsB} alt="Second prioritized pattern set mapped on the 16×16 board" loading="lazy" className="rounded-lg border" />
  </div>
</Figure>
...
<Figure caption="Blackwood's fill order: a bottom-left row scan to depth 180, border pieces interspersed afterwards. Figure by Jef Bucas (wrapper_blackwood), reproduced with permission.">
  <img src={boardOrder} alt="The order in which Blackwood's solver fills the 16×16 board" loading="lazy" className="mx-auto max-w-md rounded-lg border bg-white p-2" />
</Figure>
