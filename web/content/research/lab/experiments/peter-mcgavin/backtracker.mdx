...
metaDescription: "McGavin's C backtracker decoded and built on an M1: a 2007 speed recipe compounded for 20 years, ~204/256 pieces deep at ~109M placements/s, single core."
kind: experiment
...
- **The placement path as a measured choice.** Scan-row is best for E2, but
  spiral-in wins on clue puzzles 1 and 3, frame-first on 2 and 4, and spiral-out
...
charmingly domestic. For the 10x10 campaign he started with about 20 cores at
...
4,739,821,621,743 5x5 corner blocks of Brendan's 10x10, against a complex theory
...
**The 10x10, above all.** Brendan's set_1 10x10, a benchmark that had stood open
...
Configured as shipped, on Joe's 18-hint 16x16 test puzzle, it is very fast and it
finishes:
