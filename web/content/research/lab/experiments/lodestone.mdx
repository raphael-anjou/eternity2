...
board, weighted up sharply for the rarest — a piece that is the only possible
...
tiebreaker. LODESTONE is honest about its size: it improves construction
...
more noise? And is the consistency gain worth more than the median gain — a
tighter search is easier to build a ladder on?
