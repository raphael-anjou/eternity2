...
The measured effect is small but real: an interior *built against* its own rim
attaches with a few more matched edges than the same-quality interior grafted
on afterward, the border-interior coupling that whole-board search averages
away. 453 unhinted; high-440s to low-450s with all five clues forced.
