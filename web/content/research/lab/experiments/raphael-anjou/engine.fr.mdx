...
par [les expériences d'ici](/research/lab/experiments) est de 463 sur 480 ; le
...
[backtracker JIT](/research/lab/experiments/raphael-anjou/jit-backtracker) demande à
quelle vitesse une recherche Rust *portable* peut aller, et atteint un
[débit de la classe de McGavin](/research/lab/experiments/peter-mcgavin/backtracker)
...
[des axes différents](/research/lab/experiments/raphael-anjou/going-fast), et le moteur
