...
One note on what ships today: the runs behind these numbers were exploratory, any
board linked from these pages is verifiable in the viewer, and no packaged
one-command reproduction exists yet.
