...
description: >-
  ...
  presets are documented here; the constructive engines are not yet published.
metaDescription: "The shared engines behind Raphael Anjou's Eternity II experiments: the CSP presets, documented here as the apparatus the studies run on."
kind: page
order: 5
...
<div className="not-prose grid gap-4 md:grid-cols-2">
  <Door to="/research/lab/experiments/single-core-benchmark/csp-presets" title="The CSP presets">
    ...
    These are faithful reimplementations of known community techniques, kept so
    their exact cost can be measured against the other engines.
  </Door>
</div>

The two constructive engines these studies also lean on, the beam producer and
the ALNS polish stage, are not yet published; their write-ups are held back for
now. Where an experiment steers one of them, its own page says what the engine
does at the level the study needs.
