...
command. One caveat on today's state: the experiment runs quoted around this lab
were exploratory, their boards are verifiable in the viewer where linked, and no
packaged one-command reproduction of those runs ships yet.
