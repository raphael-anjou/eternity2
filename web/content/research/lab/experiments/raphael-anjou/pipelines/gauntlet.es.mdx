...
metaDescription: "GAUNTLET ejecuta una búsqueda en haz sobre nueve órdenes de recorrido para explorar regiones distintas en vez de converger: el zigzag encontró un 458 inédito."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
