...
by the same corner-perm-plus-Hamming test [PRIOR](/research/lab/experiments/raphael-anjou/pipelines/prior)
uses.
...
[PRIOR](/research/lab/experiments/raphael-anjou/pipelines/prior), so the run is not
