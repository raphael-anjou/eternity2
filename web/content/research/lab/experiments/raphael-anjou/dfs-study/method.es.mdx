---
title: Cómo está construido el estudio DFS
description: >-
...
metaDescription: "El motor detrás del estudio DFS: un backtracker componible en profundidad donde cada variante es un único cambio declarado sobre su padre. Una capa IO compartida, un scorer canónico que re-puntúa cada tablero, y las definiciones de la tasa de nodos, la profundidad y las rupturas."
kind: page
contribution: method
