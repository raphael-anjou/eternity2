...
metaDescription: "Le moteur de l'étude DFS : un backtracker composable où chaque variante est un changement au-dessus d'un parent, une couche IO partagée, débit et profondeur."
kind: page
contribution: method
