...
metaDescription: "BANDSAW résout exactement une bande de rangées d'Eternity II en se rejoignant au milieu, pour trouver la vraie meilleure fin et mesurer à quelle distance une finale se décide. Une analyse par recherche exacte bidirectionnelle pour sonder la structure de finale du plateau, non pour battre un record."
kind: experiment
