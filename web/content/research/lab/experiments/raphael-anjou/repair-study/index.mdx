...
description: >-
  ...
  board to start from?
metaDescription: "A single-core study of destroy-and-repair local search for Eternity II: what each decision in the loop is worth, measured one change at a time on ten corner-pinned variants in 60 s. Where to destroy, how to rebuild, when to accept, when to restart, and which starting board wins."
kind: page
