...
The point is not to win. Most variants finish in the low 400s, and the one that
does best does so by starting from a strong backtracked board rather than a
...
- **The acceptance rule is the other real lever.** Simulated annealing, which
  ...
  by a clear margin (mean 377, best 394, second only to random destroy), well
