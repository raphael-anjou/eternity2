...
metaDescription: "The repair study's engine: a composable destroy-and-repair loop, an incremental mismatch map, and definitions of the stall, lift and accept rate."
kind: page
contribution: method
