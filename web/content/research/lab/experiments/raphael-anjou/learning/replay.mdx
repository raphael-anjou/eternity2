...
description: >-
  ...
  cell.
metaDescription: "REPLAY rebuilds the community's strict 460 Eternity II boards exactly, and in doing so reveals the move ordinary solvers can't make: paying two mismatches at a single cell. A reconstruction that decodes how the record boards were actually reached, not just their final score."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
...
community record has since advanced to 465), but this project's own break-allowing
