...
description: >-
  ...
  propre plage.
metaDescription: "LODESTONE incite une recherche Eternity II partie de zéro à engager tôt les pièces rares, via un prior de demande rare servant de simple départage. Sans relever le plafond, elle atteint fiablement le haut de sa plage : médiane 449→451, dispersion réduite à 450-451 ; le surpondérer effondre tout."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
