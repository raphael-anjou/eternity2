...
metaDescription: "LODESTONE nudges an Eternity II from-scratch beam search to commit rare pieces early, via a scarce-demand prior used only as a tiebreak. It does not raise the ceiling but reliably reaches the top of its range: median 449 to 451, spread tightening to 450-451; over-weighting it collapses the build."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
