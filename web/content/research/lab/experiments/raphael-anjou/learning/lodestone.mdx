...
metaDescription: "LODESTONE nudges a from-scratch Eternity II search to commit rare pieces early: it doesn't raise the ceiling but reliably reaches the top of its own range."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
