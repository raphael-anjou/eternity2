...
description: >-
  ...
  projet : 463 sur 480.
metaDescription: "PALIMPSEST lit chaque plateau fort d'Eternity II pour repérer les habitudes qui brident discrètement un plateau, puis les brise. Il a produit le meilleur plateau de ce projet — 463 sur 480 — en extrayant les anti-schémas du corpus et en détournant la recherche de ceux-ci."
kind: experiment
hardware:
  cores: 8
  cpu: "Apple M1"
...
repro:
  ...
  topic: record-boards
  scope: >-
    La commande recalcule le score du plateau à 463 versionné à partir de ses arêtes Bucas brutes ; elle revérifie l'artefact stocké, non la recherche ALNS stochastique qui l'a trouvé.
stages:
