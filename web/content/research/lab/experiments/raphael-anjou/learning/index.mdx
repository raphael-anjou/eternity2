...
metaDescription: "Five experiments in learning from strong Eternity II boards: PRIOR, KEYRING, LODESTONE, PALIMPSEST and REPLAY read a CC0 corpus of 7,658 boards for structure and feed it back into a search as a bias. Each reaches the top of its own range fast, and all five hit the same rigidity wall."
kind: page
order: 28
