...
description: >-
  ...
  honest — the pinned-seam floor.
metaDescription: "The apparatus behind the hint study: a size-parametric Eternity II board generator, a family of fill-path backtrackers, one canonical scorer, and the pinned-seam floor that keeps a hint-count comparison honest. With the census-balance and frontier-branching arithmetic in full."
kind: page
contribution: method
...
results honestly — the arithmetic of the *pinned-seam floor*, which is what
...
border colours and seventeen interior. One honest caveat keeps the scaling trend a
*future* result rather than a reported one: at the smallest sizes the frame's cap of
five border colours leaves too few interior colours for the recipe to stay faithful
(at $8\times8$ only one), so a clean, unconfounded size sweep needs the recipe
refined at the low end first. The size-parametric machinery is in place and
validated; the trend itself is deferred rather than reported half-confounded. The
results on this page are all at $16\times16$.
...
## The pinned-seam floor: keeping the count axis honest
