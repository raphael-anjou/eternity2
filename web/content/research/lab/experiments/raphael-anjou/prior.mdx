...
related:
  ...
  - /research/lab/experiments/raphael-anjou/gauntlet
...
The build is seeded but its final lift uses a stochastic refinement tail, so
treat the board as the artifact of record. The prior-matrix builders (base,
rotation-aware, per-basin) and the novelty check live in the vault under
`v155_prior`.
