...
metaDescription: "El backtracker Eternity II de Rust a WebAssembly: un motor de referencia, no de récords, portado cuatro veces y validado byte a byte para reejecutar las cifras."
kind: page
