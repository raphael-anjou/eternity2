...
metaDescription: "Dénombrements exacts des remplissages valides d'un petit bloc d'Eternity II, sous contraintes croissantes : des nombres sûrs pour vérifier un solveur."
kind: reference
order: 60
