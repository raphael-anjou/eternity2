...
repro:
  ...
  scope: "Reproduces the 17/5 interior/frame color split only. The hardness-peak location and 'one expected solution' claim rest on the cited external sources (Owen msg 1947, Ansótegui/Mateu), not on this command."
---
