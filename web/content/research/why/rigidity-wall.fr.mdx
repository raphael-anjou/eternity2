...
sources:
  ...
  - label: "Tests indépendants de résidu SAT sur halo et de gel des répliques de William Millilaw, reproduits ici sur les plateaux records publics (tous UNSAT jusqu'à un halo de deux cellules)"
...
propres pièces d'un plateau record ne referme un seul désaccord. La
