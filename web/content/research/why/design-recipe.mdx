...
sources:
  ...
  - label: "The piece design-space census — 256 pieces from roughly 21,000 possible, symmetric forms avoided (msg 8014)"
...
had to solve it. In February 2001 — Eternity I barely cold, Eternity II a
rumour — guenter stertenbrink asked the group how one would design a puzzle
...
about a thousand times cheaper than a row scan), but on E2's actual
parameters no such region exists — the design has, in his words, "no weak
areas to start tiling from"
([msg 5243](https://groups.io/g/eternity2/message/5243), order table
...
rotation — and the real set pointedly avoids all of them
...
derivation with simulations, computed that the 17+5 design is over a
hundred times harder than a 16+8 alternative, and followed up with a table
of hardest parameters for every board size — a general recipe, of which E2
is the 16×16 row ([msg 2164](https://groups.io/g/eternity2/message/2164)).
...
discussed on the list has around 10^40 solutions and is easy
...
people who beat him. The group suspected this from launch week
...
TOMY launch material stated that nobody — not the inventor, not the
...
Honestly: every generic shortcut you might reach for was anticipated and
...
community's twenty years of records — 467 in 2008, 470 by 2020, none since —
...
anticipate — which is, in the end, what this wiki is for.
