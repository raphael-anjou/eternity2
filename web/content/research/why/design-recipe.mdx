...
design from the same one-expected-solution family — it better balances the
tileability of border and interior pieces, leaving no cheap way in through
the frame ([msg 2426](https://groups.io/g/eternity2/message/2426)) — and
followed up with a table of hardest parameters for every board size — a
