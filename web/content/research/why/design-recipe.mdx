...
designs, including forms like *aaaa* and *abab* that repeat under
...
frame-only colours are also the rare ones, quarantined at the rim: with fewer
border pieces than interior pieces, and border cells taking only one
orientation, Owen's recipe levels the two groups so their pieces stay about
equally tileable rather than leaving the frame as a soft, uneven entry point
([msg 1947](https://groups.io/g/eternity2/message/1947)). That visible
signature has [its own page](/research/why/rare-color-geography).
...
community's raw ceiling has moved twice in twenty years (467 in 2008, 470 in
2021) and has held there since (the strict-clue track has kept moving
independently; see [/research/records](/research/records)); that plateau is
the empirical readout of a design that worked precisely as intended.
