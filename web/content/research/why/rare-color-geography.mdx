...
metaDescription: "Five of Eternity II's 22 colours appear only on the border ring, each on 24 edges, never in the interior: a split that shapes how solvers treat the frame."
kind: finding
