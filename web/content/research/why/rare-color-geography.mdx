...
metaDescription: "Five of Eternity II's 22 colours appear only on the border ring, each on exactly 24 edges, never once in the interior. This structural split leaves the 14x14 interior to seventeen common colours with no rare, tightly-constraining signal, which is a big part of why interior search barely grips."
kind: finding
