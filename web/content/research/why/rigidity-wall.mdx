...
sources:
  ...
  - label: "William Millilaw's independent halo SAT-residual and replica freeze tests, reproduced here on five public boards (every finished solve UNSAT, out to a four-cell halo)"
...
five-clue record), every solve that finished is UNSAT out to a four-cell halo: no
