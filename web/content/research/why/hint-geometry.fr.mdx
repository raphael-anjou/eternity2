...
recherche à des dizaines de milliards de placements. Un facteur cinq environ sur
le nombre, tranché par la géométrie ; le nombre exact d'indices contigus qui
égalerait dix-huit indices dispersés n'a jamais été établi.
...
<div className="grid grid-cols-2 gap-3 text-center sm:grid-cols-4">
  ...
  <div className="rounded-lg border p-4">
    ...
    <div className="mt-1 text-xs text-muted-foreground">indices en rangées contiguës pour ramener la recherche à des dizaines de milliards de placements</div>
  </div>
  <div className="rounded-lg border p-4">
