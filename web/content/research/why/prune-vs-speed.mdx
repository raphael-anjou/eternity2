...
**smaller** — prune branches that can't lead to a solution, so the effective
...
- **[On the hardness peak](/research/why/phase-transition)** — The piece and
  colour counts sit where there is about one expected solution — no
...
- **[Rigidity](/research/why/rigidity-wall)** — Even at a record board, the
  move to a better one is huge and indivisible — no gradient to follow,
...
<Callout kind="note">
  ...
  small puzzles, deterministic and reproducible with
