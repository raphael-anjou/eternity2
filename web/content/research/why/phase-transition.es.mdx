...
repro:
  ...
  scope: "Reproduce el reparto de colores 17/5 interior/marco. La localización del pico de dificultad se mide por separado en el repositorio mediante el experimento hardness-peak (un barrido de esfuerzo del solucionador en 8x8, más el criterio de Owen recalculado a 17,14 a tamaño 16); la afirmación de «una sola solución esperada» para el tablero 16x16 completo descansa aún en las fuentes externas citadas (Owen msg 1947, Ansótegui/Mateu)."
---
