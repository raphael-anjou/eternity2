...
description: >-
  ...
  5 reservados al marco, y ese número de 17 coincide exactamente con el punto
  donde este tipo de puzzle es más difícil de resolver.
metaDescription: "Los 22 colores de Eternity II se reparten en 17 interiores y 5 de marco, y ese 17 cae justo en la transición de fase donde estos puzzles son más difíciles. Brendan Owen derivó el diseño 17+5 para una dureza máxima; trabajos posteriores sobre dureza SAT/CSP confirmaron el pico."
kind: finding
...
Vea la dificultad medida en vivo en la [página de Algoritmos](/algorithms).
