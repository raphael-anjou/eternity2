...
metaDescription: "Por qué los solucionadores de Eternity II rellenan unas filas y luego mueren en el centro: una pieza escasa, gastada mal filas antes, deja sin recursos a una celda posterior. El mecanismo es el robo de piezas, y el razonamiento all-different de Régin predice dónde golpea la escasez."
kind: finding
...
repro:
  ...
  topic: piece-theft
sources:
  - label: "Régin 1994, «A Filtering Algorithm for Constraints of Difference in CSPs» (AAAI-94), el razonamiento all-different que predice la escasez"
