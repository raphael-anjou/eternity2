...
a decenas de miles de millones de colocaciones. Una diferencia de unas cinco
veces en la cantidad, decidida por la geometría; la cantidad exacta de pistas
contiguas que igualaría a dieciocho repartidas nunca se determinó.
...
<div className="grid grid-cols-2 gap-3 text-center sm:grid-cols-4">
  ...
  <div className="rounded-lg border p-4">
    ...
    <div className="mt-1 text-xs text-muted-foreground">pistas en filas contiguas para bajar la búsqueda a decenas de miles de millones de colocaciones</div>
  </div>
  <div className="rounded-lg border p-4">
