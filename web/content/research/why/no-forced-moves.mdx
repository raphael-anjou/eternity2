...
description: >-
  ...
  to a single option.
metaDescription: "Eternity II has no forced moves: every one of its 196 interior pieces has 73 to 137 possible right-hand neighbours and is never pinned to a single option, so the usual logic lever is gone. That freedom is the flip side of forbidden patterns — lots of local slack, almost no global consistency."
kind: finding
