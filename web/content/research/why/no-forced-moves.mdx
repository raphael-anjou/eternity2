...
could legally sit beside it. The typical piece has over a hundred options.
Not a single piece is ever pinned to one choice.
...
Computed exactly from the official set; reproduces identically every run.
The [article, source and results are on GitHub](https://github.com/raphael-anjou/eternity2/tree/main/research/topics/no-forced-moves).
