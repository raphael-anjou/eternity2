...
description: >-
  ...
  to a single option.
metaDescription: "Eternity II has no forced moves: every interior piece has 73 to 137 possible neighbours and is never pinned to one, so the usual logic lever is gone."
kind: finding
