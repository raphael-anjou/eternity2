...
Every cell of the map below is grounded in the project's research vault. The
four walls themselves are corroborated by the published literature; the
invention results are this project's own work, reproducible from source — they
...
- **[The hardness peak](/research/why/phase-transition)** — ≈17 interior
  colours put the puzzle at the phase transition: about one expected solution,
...
ceiling on this puzzle is 469; the full solution is 480.
...
| --- | --- | :-: | :-: | :-: | :-: | --- |
| [PALIMPSEST](/research/lab/experiments/palimpsest) · from the corpus | 463/480 | | | | ● | — |
| [PRIOR](/research/lab/experiments/prior) · from scratch | 460/480 | | ● | | ● | — |
| [KEYRING](/research/lab/experiments/keyring) · from scratch | 460/480 | | | | ● | new family |
| [REPLAY](/research/lab/experiments/replay) · decode & replay | 460/480 | | | | ● | — |
| [GAUNTLET](/research/lab/experiments/gauntlet) · from scratch | 458/480 | | | | ● | new family |
| [CLOISTER](/research/lab/experiments/cloister) · anchor & constrain | 453/480 | | | ● | ● | — |
| [MIDDEN](/research/lab/experiments/midden) · anchor & constrain | 452/480 | | | ● | ● | — |
| [LADDER](/research/lab/experiments/ladder) · concentrate effort | 451/480 | ● | ● | | | new family |
| [LODESTONE](/research/lab/experiments/lodestone) · from scratch | 451/480 | ● | | | | — |
| [MOSAIC](/research/lab/experiments/mosaic) · solve a piece exactly | 448/480 | ● | ● | | | — |
| [BANDSAW](/research/lab/experiments/bandsaw) · solve a piece exactly | 437/480 | ● | ● | | | — |
| [STAGED](/research/lab/experiments/staged) · from scratch | 436/480 | ● | | ● | | — |
...
The ceiling is never arbitrary. For each method the vault records the exact
reason the score stopped climbing — quoted here in one line.

- **[PALIMPSEST](/research/lab/experiments/palimpsest)** (463/480) — Reached
  ...
  not a hard rule.
- **[PRIOR](/research/lab/experiments/prior)** (460/480) — Plateaus at 460:
...
- **[KEYRING](/research/lab/experiments/keyring)** (460/480) — Three learned
...
- **[REPLAY](/research/lab/experiments/replay)** (460/480) — Replays the
...
- **[GAUNTLET](/research/lab/experiments/gauntlet)** (458/480) — Running the
...
- **[CLOISTER](/research/lab/experiments/cloister)** (453/480) — As a
...
- **[MIDDEN](/research/lab/experiments/midden)** (452/480) — Choosing where
...
- **[LADDER](/research/lab/experiments/ladder)** (451/480) — Floods cheap
...
- **[LODESTONE](/research/lab/experiments/lodestone)** (451/480) — A
  ...
  ceiling.
- **[MOSAIC](/research/lab/experiments/mosaic)** (448/480) — Composes exact
...
- **[BANDSAW](/research/lab/experiments/bandsaw)** (437/480) — Solves an
...
- **[STAGED](/research/lab/experiments/staged)** (436/480) — Builds the whole
  board with no pre-set frame and an emergent border, reaching 436 — well
  below the records. That honest gap is the finding: it measures exactly how
  much the usual frame-first anchor is worth.

## The shape of the gap

Read down the table and the lesson of the whole project is visible at a
glance: the methods that move the score change the shape of the search — a
scan order, a learned prior, a confined region — never its raw speed. And
every one of them stops at a wall that is global, not local. The eleven edges
from 469 to 480 are not a polishing problem; they are on the far side of all
four walls at once.

<Callout kind="note">
  Each saturation line is distilled from the project's lab notebook (one
  volume per invention). The four walls are corroborated by the published
