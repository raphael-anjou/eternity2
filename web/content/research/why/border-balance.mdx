...
description: >-
  ...
  instantly the board is wrong — but obeying it guarantees nothing.
kind: finding
tier: 3
order: 120
updated: 2026-07-02
...
once from the border side, once from the interior side. In any complete
...
seam at all — they're interior-to-interior, where NS-1 never looks: on
