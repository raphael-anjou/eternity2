...
469-class boards we have looked at, the large majority of the unmatched edges
are invisible to it (an exact recount across the record set is queued as an
experiment, not yet a committed benchmark).
