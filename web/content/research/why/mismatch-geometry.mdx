...
metaDescription: "A near-perfect Eternity II board packs its few errors into one band of five rows, set by the fill direction: you can see the mirror on real record boards."
kind: finding
