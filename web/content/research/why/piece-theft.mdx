...
description: >-
  ...
  ago.
metaDescription: "Why Eternity II solvers fill a few rows for free, then die in the middle of the board: a scarce piece was spent in the wrong place rows earlier, starving a later cell. The mechanism is piece theft, and Régin's all-different reasoning predicts exactly where the starvation strikes."
kind: finding
...
repro:
  ...
  topic: piece-theft
sources:
  - label: "Régin 1994, “A Filtering Algorithm for Constraints of Difference in CSPs” (AAAI-94), the all-different reasoning that predicts starvation"
