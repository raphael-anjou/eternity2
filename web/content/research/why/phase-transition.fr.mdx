...
description: >-
  ...
  5 réservées au cadre - et ce chiffre de 17 correspond exactement au point où
  ce type de casse-tête est le plus difficile à résoudre.
metaDescription: "Les 22 couleurs d'Eternity II se répartissent en 17 intérieures et 5 de cadre, et ce 17 tombe pile à la transition de phase où ces puzzles sont les plus durs. Brendan Owen a dérivé le schéma 17+5 pour une difficulté maximale ; des travaux ultérieurs sur la dureté SAT/CSP ont confirmé le pic."
kind: finding
