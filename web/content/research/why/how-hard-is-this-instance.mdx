...
metaDescription: "Edge matching is NP-complete as a family, but one fixed 16x16 board is a constant. The family's worst case, E2's empirical hardness, and how to encode it."
kind: concept
