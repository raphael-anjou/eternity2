...
metaDescription: "Edge matching is NP-complete as a family, but one fixed 16×16 board is a constant, not a problem, so complexity theory says nothing about it directly. Real hardness is the family worst case plus E2 empirical difficulty over a ~10^557 space, with SAT, exact-cover DLX, and ILP encodings."
kind: concept
