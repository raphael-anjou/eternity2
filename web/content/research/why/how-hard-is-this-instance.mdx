...
- **Empirical hardness of this instance.** Hardness you can measure. The 16×16
  board has on the order of $1.15\times10^{557}$ distinct piece-and-rotation
...
*instance* is. See [SAT and CSP encodings](/research/build/concepts/sat-csp-encodings)
...
[exact cover and dancing links](/research/build/concepts/exact-cover-dlx) page
...
- **Integer linear programming.** Reuse the SAT variables as 0/1 integers
  ...
  search. See [LP relaxations](/research/build/concepts/lp-relaxations).
...
[arc consistency](/research/build/concepts/arc-consistency) and smart search
