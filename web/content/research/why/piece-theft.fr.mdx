...
metaDescription: "Pourquoi les solveurs d'Eternity II remplissent quelques rangées puis meurent au milieu : une pièce rare, dépensée au mauvais endroit des rangées plus tôt, affame une case ultérieure. Le mécanisme est le vol de pièce, et le raisonnement all-different de Régin prédit où survient la pénurie."
kind: finding
...
repro:
  ...
  topic: piece-theft
sources:
  - label: "Régin 1994, « A Filtering Algorithm for Constraints of Difference in CSPs » (AAAI-94), le raisonnement all-different qui prédit la pénurie"
...
moment où la case se révèle sans fournisseur, ce qui explique pourquoi ce mur a
résisté à tant de tentatives d'élagage précoce.
