...
description: >-
  Almost every small patch of pieces you could build is impossible. For a 2×2
  square, 99.72% of the ways to place four pieces can never be made to match.
metaDescription: "Almost every small patch of Eternity II pieces is impossible: for a 2×2 square, 99.72% of the ways to place four pieces can never be made to match. This proven forbidden-pattern density is what arc-consistency exploits, and why local moves so rarely lead anywhere."
kind: finding
contribution: theory
rigor: proven
tier: 1
