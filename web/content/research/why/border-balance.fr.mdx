...
intérieur, là où NS-1 ne regarde jamais : sur les plateaux de la classe 469 que
nous avons examinés, la grande majorité des arêtes non appariées lui sont
invisibles (un recomptage exact sur l'ensemble des records est mis en file comme
expérience, pas encore un banc de mesure figé).
