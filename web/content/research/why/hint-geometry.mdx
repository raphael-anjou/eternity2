...
metaDescription: "On a 16×16 puzzle built to Eternity II's exact colour recipe, hint position beats hint count: 18 scattered hints solve it in minutes, while 80+ piled into contiguous rows barely match, because 99% of the search happens past depth 132 of 256. The hints that count are the ones reaching the endgame."
kind: finding
