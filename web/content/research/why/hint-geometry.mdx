...
placements. Roughly a fivefold difference in count, decided by geometry; the
exact count at which contiguous hints match eighteen scattered ones was never
pinned down.
...
<div className="grid grid-cols-2 gap-3 text-center sm:grid-cols-4">
  ...
  <div className="rounded-lg border p-4">
    ...
    <div className="mt-1 text-xs text-muted-foreground">contiguous-row hints to reach tens of billions of placements</div>
  </div>
  <div className="rounded-lg border p-4">
