...
repro:
  ...
  scope: >-
    El reparto interior-interior / interior-borde / borde-borde de las aristas
    no emparejadas de cada tablero alto del corpus, recontado a partir de los
    datos de tableros versionados.
---
