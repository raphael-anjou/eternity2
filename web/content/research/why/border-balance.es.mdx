...
description: >-
  ...
  nada.
metaDescription: "El equilibrio del borde en Eternity II: cada color que el borde da al interior, el interior lo devuelve — mismo multiconjunto. Un déficit Δ>0 prueba que un tablero nunca se completará; Δ=0 no prueba nada, pues intercambios y errores internos se le escapan. Descarta 10–28 % de callejones sin salida."
kind: finding
contribution: theory
rigor: measured
tier: 3
...
anillo de borde, imponer $\Delta = 0$ rechaza entre el 10 y el 28 % de los
