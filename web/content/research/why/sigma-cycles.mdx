...
only one of it. Going from a 458 board to the community's 469 means one
...
better board is one indivisible 150-cell move away. The 469 record has stood
since 2020 for exactly this reason: the moves that would beat it are too
