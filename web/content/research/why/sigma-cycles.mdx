...
only one of it. Going from a 458 board to McGavin's 469 means one
...
Not a diagram — the live engine finds two real solutions, computes the actual
...
- **In every case, every smaller piece of the cycle scores worse. The
  property is universal across the basins we tested.**
