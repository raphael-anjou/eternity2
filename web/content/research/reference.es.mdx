...
metaDescription: "Recuentos exactos de las formas válidas de rellenar un bloque en una posición de Eternity II, con reglas más estrictas: números fiables para tu solucionador."
kind: reference
order: 60
