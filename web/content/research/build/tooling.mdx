...
metaDescription: "Nineteen years of Eternity II community software, catalogued: manual-placement GUIs, board editors, public solvers, generators and viewers. Plus the quieter layer that let tools interoperate without shipping the copyrighted pieces: e2pieces.txt, CRC-16 checksums, the board-in-a-URL format."
kind: reference
order: 18
