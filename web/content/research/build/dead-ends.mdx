...
description: >-
  ...
  elsewhere.
metaDescription: "Eternity II approaches that look promising but don't move the score, documented so you don't repeat them: probability propagation that fades two cells out, macro-tiles that speed search without shrinking the domain, border-supply pruning that ran 8% slower for a 0.0014% gain."
kind: reference
order: 50
group: Skip these
updated: 2026-07-02
