...
metaDescription: "Encoder Eternity II en clauses SAT/CSP pour des solveurs industriels : pourquoi la recherche CDCL complète s'enlise sur le plateau 16×16 malgré l'encodage compact de Heule. Les instances se chargent mais restent non résolues, quand leurs verdicts UNSAT sub-seconde prouvent l'impossibilité locale."
kind: concept
order: 80
group: Exact methods
updated: 2026-07-02
