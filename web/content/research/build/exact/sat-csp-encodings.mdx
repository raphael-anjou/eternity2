...
description: >-
  ...
  proofs.
metaDescription: "Encoding Eternity II as SAT/CSP clauses for industrial solvers: why complete CDCL search stalls on the full 16×16 board despite Heule's compact seam encoding. The instances load fine but never solve, yet their sub-second UNSAT verdicts prove local impossibility."
kind: concept
order: 80
group: Exact methods
updated: 2026-07-02
