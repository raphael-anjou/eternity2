...
description: >-
  ...
  credit.
metaDescription: "Eternity II as exact cover: Knuth's Algorithm X and dancing links (DLX) encode it faithfully via XCC with colours. Where DLX shines — exhaustive counts, uniqueness proofs, small boards — and the two structural walls that stop it cracking the 16×16: a tree it never shrinks, and no partial credit."
kind: concept
order: 30
group: Exact methods
updated: 2026-07-02
