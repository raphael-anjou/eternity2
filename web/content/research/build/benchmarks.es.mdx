...
este. Figura en el
[tablero de problemas abiertos](/research/open-problems) como el objetivo con
nombre más cercano por debajo del puzzle completo; si le echas una carrera,
[contribuir](/research/contribute) el tablero o las estadísticas le da al
...
rápido ([mensaje 11750](https://groups.io/g/eternity2/message/11750)) - aunque esa
es una cifra de *tablero fácil*; en un tablero difícil el mismo motor corre a ~105 M,
donde un
[motor en Rust portable en este sitio](/research/lab/experiments/raphael-anjou/jit-backtracker)
lo iguala. Dos
