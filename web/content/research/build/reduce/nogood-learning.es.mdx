...
description: >-
  ...
  realmente rinde.
metaDescription: "Aprendizaje de no-goods en Eternity II: un subárbol fallido es un teorema, este estado parcial nunca podrá extenderse, memorízalo y no vuelvas a entrar. La comunidad probó dos variantes, tablas de transposición sobre la frontera y restricciones extraídas del puzzle, y midió dónde rinde la memoria."
kind: concept
order: 190
