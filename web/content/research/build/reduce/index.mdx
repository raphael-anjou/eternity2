...
description: >-
  Everything that throws away hopeless states before the search wastes time on them: propagation to a fixed point, the all-different matching filter, learned no-goods, and the…
metaDescription: "Reducing Eternity II search: propagation to a fixed point, the all-different matching filter, and learned no-goods that drop hopeless states early."
kind: page
order: 40
