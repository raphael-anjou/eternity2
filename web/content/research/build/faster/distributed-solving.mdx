...
sources:
  ...
  - label: "The 10×10 top-row list: 4,318,956 rows to reserve (groups.io message 9164)"
    url: https://groups.io/g/eternity2/message/9164
  - label: "McGavin's 400+-core row farm solves the 10×10 (groups.io message 9688)"
...
That conclusion is being tested live as this is written: a shared five-clue
fleet whose orchestrator allocates roots, deduplicates them and re-scores
every board that comes back, pointed at a target the community can actually
model. It is documented, and joinable, on
[the five-clue fleet page](/research/community/five-clue-fleet).
