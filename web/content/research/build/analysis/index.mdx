...
title: Analysis
description: >-
  These do not try to solve the puzzle: they measure it, which is how the community knows where the walls are. Parity arguments give one-pass impossibility proofs; solution…
metaDescription: "Analysis methods that measure Eternity II rather than solve it: parity arguments, solution counting, and other tools for locating the search's hard walls."
kind: page
order: 46
group: Analysis
updated: 2026-07-13
