...
metaDescription: "How the Eternity II community built a shared test culture despite a copyright ban on sharing the pieces: derived-count census protocols, the Txibilis and beginner suites, node-count duels, full enumerations from the 6×6 to hints.20.3, and the one 10×10 benchmark still standing open today."
kind: reference
order: 17
...
sources:
  - label: "The 3×3 corner census proposal: 'Suggestion for Benchmark/Test' (arthurhucksake), eternity2@groups.io, 2007-08"
  ...
  - label: "Brendan's set_1 10×10 solved (Peter McGavin), eternity2@groups.io, 2017-09"
...
## The 9×9 pair: exhausted, then re-verified on a GPU
...
## Brendan's 10×10s: one fell, one is still standing
...
want a benchmark with a name to make, this is the one. It sits on the
[open problems board](/research/open-problems) as the nearest named target below
the full puzzle; if you take a run at it, [contributing](/research/contribute)
the board or the statistics gives the result a permanent home.
...
core ([message 11750](https://groups.io/g/eternity2/message/11750)) - though that is
...
[solver-engineering ledger](/research/build/faster/solver-engineering) pins down
