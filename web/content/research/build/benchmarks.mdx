...
metaDescription: "How the Eternity II community built a shared test culture without sharing pieces: derived-count verification, the Txibilis suites, and node-count duels."
kind: reference
order: 17
...
sources:
  ...
  - label: "Dave Clark's Sample Puzzles suite and documented file format (groups.io Files)"
    url: https://groups.io/g/eternity2/files/Sample%20Puzzles
  - label: "The sized benchmark boards, sides 11-16 (groups.io Files)"
...
test: tile the top-left 3x3 corner with all E2 pieces and count. The answer
...
gap is exactly what [complex theory](/research/why/complex-theory) later
...
was the 16x16 `hints.20.3` puzzle, fully enumerated on a single 3.5 GHz
core: **29,481,602,025,785 nodes** (about 2.9 × 10¹³), 15.6 CPU-days,
exactly **one** solution
([message 7861](https://groups.io/g/eternity2/message/7861)). He posted it
...
second** ([message 11826](https://groups.io/g/eternity2/message/11826)). Concrete
...
([message 11835](https://groups.io/g/eternity2/message/11835)), and Peter
McGavin's optimised backtracker hit ~295 million per second on a fast single
core ([message 11750](https://groups.io/g/eternity2/message/11750)). Two cautions
...
the search spends its time in the dense forest of near-border constraints. None
of this changes the [prune-versus-speed](/research/why/prune-vs-speed) verdict:
...
The [Benchmarks folder](https://groups.io/g/eternity2/files/Benchmarks)
