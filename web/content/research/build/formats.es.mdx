...
metaDescription: "La especificación a nivel de byte de cada formato de tablero y puzzle de Eternity II: board_edges, board_pieces, e2pieces.txt, CSV, JSON Puzzle del sitio, salida BoardDoc y ambas URL de visor. Cómo codifica cada uno el borde gris, y si recupera la rotación y la identidad de pieza."
kind: reference
order: 8
group: Start here
