...
title: Backtracking
description: >-
  Depth-first search done seriously. The order a solver visits the cells is its one free choice and moves the tree size by orders of magnitude; restarts turn a heavy-tailed runtime…
metaDescription: "Depth-first search for Eternity II: cell-visit order moves tree size by orders of magnitude, and restarts tame the heavy-tailed runtime of a single run."
kind: page
order: 41
group: Backtracking
updated: 2026-07-13
