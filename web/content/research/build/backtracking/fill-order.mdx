...
metaDescription: "How the order a backtracker visits the 256 cells moves search-tree size by orders of magnitude: fixed vs dynamic, the 10x16 square, Verhaard's comb search."
kind: concept
order: 110
group: Backtracking
updated: 2026-07-02
...
sources:
  ...
  - label: "Markus Zajc's 8x8 head-to-head, minimum-remaining-value beats scanline beats max-reduction (September 2008)"
...
$10^{57}$ around 160 pieces, versus about $10^{43}$ for scan-row. A frame-first
