...
metaDescription: "A public CC0 Eternity II dataset in two parts: 14 benchmark instances to solve and a corpus of 7,658 distinct strong boards scoring 400 to 470 to learn from. Every score is recomputed from the board's edges rather than trusted, and the corpus is verified to be genuinely diverse."
kind: reference
order: 55
