...
description: >-
  ...
  by days — then an outsider from Reddit rewrites the record book. Every
...
sources:
  ...
  - label: "Peter McGavin solves Brendan Owen's 10×10 — ~180 core-years, inside complex theory's error bars (groups.io message 9686)"
  ...
  - label: "Bruno Gauthier's 460 — the best board honouring all five clues (groups.io message 11074)"
...
[Part I](/research/build/history) ended in January 2009 with a $10,000
...
public eii solver on a single PC and logged the climb: two million 463s,
625 466s, and finally — at day ~82 — a 467, independently reproducing the
prize score with the public binary and quantifying just how thin the air
gets above 466 ([msg 6687](https://groups.io/g/eternity2/message/6687)). In
...
depths — edge slipping, gated by depth
...
Verhaard confirmed nobody had improved on his 467
([msg 7494](https://groups.io/g/eternity2/message/7494)) — and republished
his solver at shortestpath.se, its long-term home, after his band's website
folded ([msg 7439](https://groups.io/g/eternity2/message/7439)).
...
([msg 7755](https://groups.io/g/eternity2/message/7755)), framing the era's
honest goal: solving E2 itself being hopeless, "the challenge is clear: beat
468 matching edges"
([msg 7803](https://groups.io/g/eternity2/message/7803)). When his
Monte-Carlo estimator disagreed with Brendan Owen's complexity model by five
...
one line: "No decisions will be made until the next scrutiny date"
([msg 8006](https://groups.io/g/eternity2/message/8006)). The deadline of
31 December 2010 passed in gallows humour — members joking about couriering
a hypothetical last-minute solution to the post office
([msg 8193](https://groups.io/g/eternity2/message/8193)). Then the official
site went dark, "suspended pending final scrutiny confirmation"
([msg 8270](https://groups.io/g/eternity2/message/8270)); Verhaard posted "I
can honestly tell you that I didn't solve it"
...
man who had founded the group before the puzzle existed, said goodbye: "It
was great fun" — asking Verhaard to congratulate his wife on the highest
score, first-party confirmation that 467 stood at the contest's close
...
([msg 8636](https://groups.io/g/eternity2/message/8636)). The other was the
...
adjusters ([msg 8502](https://groups.io/g/eternity2/message/8502)) — and
Owen gave the statement still quoted today: Alex Selby and Oliver Riordan
created a solution when Monckton paid them to generate a practically
impossible puzzle, and it lies "hidden amongst reams of printed text locked
in a safe" as insurance against legal challenge
...
exhaustive searches of Owen's 9×9 benchmarks landed within an order of
...
2015 ([msg 9271](https://groups.io/g/eternity2/message/9271)) — and its
expiry passed without a single mention on the list. When newcomer Dima asked
...
transcribed Owen's complexity model into LaTeX — complex_theory.pdf, in the
group's files ([msg 9188](https://groups.io/g/eternity2/message/9188)) —
...
([msg 9519](https://groups.io/g/eternity2/message/9519)). The claim-filter
...
The same thread detonated a records bombshell that never resolved: Dima
...
joins matched — "unframed E2", gray edges buried in the interior — and was
scrupulously precise that it was not a solution to the puzzle
...
photos intact ([msg 9934](https://groups.io/g/eternity2/message/9934)). The
...
astonishing 249-piece flawless partial was real, "no cheating… found after
a week or so, on 1 computer"
...
Blackwood open-sourced the solver itself — with heuristic changes he
believed made it "twice as good", pre-configured to hunt 469s
...
([msg 10161](https://groups.io/g/eternity2/message/10161)) — and retired: "I
...
rules pinned only the starter piece — Tomy's entry form listed piece
numbers, not rotations, and the four other clues were optional aids
...
positions — verified at board level for the 469 and the 470 alike
...
long-standing 226 to 227, then 230 — "a single PC in my basement"
...
provenance. In May 2022 Al Hopfer — a regular since 2008 — stated the
border condition now known on this site as the NS-1 balance: the outer rim
...
to Bruno Gauthier's 460 — still the best known board under the full-clue
discipline ([msg 11074](https://groups.io/g/eternity2/message/11074)). The
...
([msg 11193](https://groups.io/g/eternity2/message/11193)) — and the next
day published complex_theory.c, his exact C implementation of Owen's model
([msg 11197](https://groups.io/g/eternity2/message/11197)): the reference
this site's own [complexity engine](/research/build/solvers/blackwood)
...
crediting never wavered — "Joshua Blackwood is the current record holder. I
...
concluding the author's manual tuning was already near-optimal; his notes
...
([msg 11755](https://groups.io/g/eternity2/message/11755)). And in February
2026, the annual welcome note opened with a tribute to Kronjuvel — Ole
Knudsen, who created the group, ran it for two decades, and has been
missing from the list since 2023
