...
metaDescription: "Corpus priors for Eternity II: count where pieces sit in strong boards and use it as a construction tiebreak, safe only as a tiebreak, never the objective."
kind: concept
order: 50
...
[PRIOR](/research/lab/experiments/raphael-anjou/pipelines/prior) experiment, which
...
[LODESTONE](/research/lab/experiments/raphael-anjou/pipelines/lodestone) experiment, and
