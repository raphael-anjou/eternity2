...
related:
  ...
  - /research/lab/experiments/raphael-anjou/pipelines/lodestone
---
...
[LODESTONE](/research/lab/experiments/raphael-anjou/pipelines/lodestone) is the cleanest
...
that stops every method near the top." [PRIOR](/research/lab/experiments/raphael-anjou/pipelines/prior)
and [KEYRING](/research/lab/experiments/raphael-anjou/pipelines/keyring) reach 460 from
scratch, the top of the from-scratch range, but not past it.
[PALIMPSEST](/research/lab/experiments/raphael-anjou/pipelines/palimpsest), the strongest
