...
metaDescription: "Learned move-ordering for Eternity II: rank candidate placements by several signals learned from strong boards and let them vote, instead of one fixed rule."
kind: concept
order: 51
...
This is the [KEYRING](/research/lab/experiments/raphael-anjou/pipelines/keyring)
