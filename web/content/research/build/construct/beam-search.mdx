...
description: >-
  ...
  interior.
metaDescription: "Beam search keeps the K best partial Eternity II boards alive, growing them cell by cell: this project's from-scratch builder, and why breadth stalls deep."
kind: concept
order: 50
...
orders ([GAUNTLET](/research/lab/experiments/raphael-anjou/runs/gauntlet)) produced eighteen
distinct board families where sixteen seeds of a single order had produced
one.

The other productive dial is the tiebreak.
[PRIOR](/research/lab/experiments/raphael-anjou/runs/prior) breaks score ties toward pieces that
...
[LODESTONE](/research/lab/experiments/raphael-anjou/runs/lodestone) breaks ties toward pieces
