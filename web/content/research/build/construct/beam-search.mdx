...
related:
  ...
  - /research/lab/experiments/raphael-anjou/staged
  - /research/lab/experiments/raphael-anjou/lodestone
...
orders ([GAUNTLET](/research/lab/experiments/raphael-anjou/gauntlet)) produced eighteen
distinct board families where sixteen seeds of a single order had produced
one.

The other productive dial is the tiebreak.
[PRIOR](/research/lab/experiments/raphael-anjou/prior) breaks score ties toward pieces that
...
[LODESTONE](/research/lab/experiments/raphael-anjou/lodestone) breaks ties toward pieces
