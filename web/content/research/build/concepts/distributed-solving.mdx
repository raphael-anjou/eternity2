...
that are impossible "with the current computer power in the time frame", no
...
went ahead and built the distributed projects anyway — repeatedly, in two
distinct shapes. Both are worth understanding, because one of them turned
out to be genuinely useful. The social history — the rise and fall of
eternity2.net, the contest politics around it — lives in
[the history pages](/research/build/history); this page is the systems view.
...
([message 768](https://groups.io/g/eternity2/message/768)); the crowd came
anyway. Within a month it had over 1,300 signed-in members — 160 of them in
the USA, where the puzzle had not yet been released
([message 2122](https://groups.io/g/eternity2/message/2122)). The project
...
search space — same architecture as eternity2.net — but with an explicit
...
([message 1253](https://groups.io/g/eternity2/message/1253)). In May 2008
...
[The eii page](/research/build/solvers/verhaard-eii) tells that story in
...
**Peter McGavin's scavenged farm.** McGavin built his fleet out of whatever
was cheap: ~20 cores at home, three ODROID XU4s, twenty-five $12 Orange Pi
Lites — 130+ cores — then borrowed work servers for 400+ in total. In 2017
...
later he pointed roughly 200 cores at Joshua Blackwood's newly released
...
The cloud made cameo appearances — Amazon EC2 suggested as early as 2010
([message 8106](https://groups.io/g/eternity2/message/8106)), David Barr
running searches on AWS Lambda's free tier in 2016
...
| Eternity 2 Syndicate (Amos, 2007) | Volunteer swarm + prize contract | ~40 members, 50 instances, ~300M placements/s | No record; faded with the site | [3021](https://groups.io/g/eternity2/message/3021), [3105](https://groups.io/g/eternity2/message/3105) |
...
| McGavin's row farm (2016–17) | Owned fleet (scavenged) | 400+ cores | Brendan's set_1 10x10 solved, ~180 core-years | [9686](https://groups.io/g/eternity2/message/9686), [9688](https://groups.io/g/eternity2/message/9688) |
| McGavin on Blackwood's solver (2020) | Owned fleet | ~200 cores, a few days | 469/480 — the record of its day | [10045](https://groups.io/g/eternity2/message/10045) |
...
([message 3021](https://groups.io/g/eternity2/message/3021)) — and it is
the weakest form, because on the full puzzle every band is equally hopeless.
...
of [Blackwood's solver](/research/build/solvers/blackwood) parameters;
...
eii's 50-50, E2@home's share of the lesser prize — were attempts to keep
volunteers honest and motivated inside that forced secrecy. When the
...
- **Parameter studies.** wrapper_blackwood is the modern template: when the
  ...
  the jobs are honest, bounded, and independent — exactly what distribution
  wants.
