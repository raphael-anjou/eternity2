...
of 480 matched edges, with this project's own experiments clustered at
460–463. They stall there for the same reason, and it is worth stating before
...
- **[Fill orders](/research/build/concepts/fill-order)**. The order a
...
- **[Arc consistency](/research/build/concepts/arc-consistency)**. Make every
...
- **[All-different, Régin's matching filter](/research/build/concepts/alldiff-regin)**.
  ...
  mismatches.
- **[No-good learning](/research/build/concepts/nogood-learning)**. A failed
...
- **[Restarts and heavy tails](/research/build/concepts/restarts)**. The same
...
- **[Meet in the middle](/research/build/concepts/meet-in-the-middle)**.
...
- **[Exact cover and dancing links](/research/build/concepts/exact-cover-dlx)**.
  ...
  near-miss.
- **[Solver engineering](/research/build/concepts/solver-engineering)**. Not an
...
- **[SAT and CSP encodings](/research/build/concepts/sat-csp-encodings)**.
...
- **[LP and ILP relaxations](/research/build/concepts/lp-relaxations)**. Write
...
- **[Local search and ALNS](/research/build/concepts/local-search-alns)**.
  ...
  polishing ends.
- **[Simulated annealing and parallel tempering](/research/build/concepts/parallel-tempering)**.
...
- **[Beam search](/research/build/concepts/beam-search)**. Keep the K most
...
- **[Evolutionary and genetic approaches](/research/build/concepts/evolutionary)**.
...
- **[Iterated maps and divide-and-concur](/research/build/concepts/iterated-maps)**.
...
- **[GPU solving](/research/build/concepts/gpu-solving)**. Looks like the
...
- **[FPGA solving](/research/build/concepts/fpga-solving)**. Put the lookup
  ...
  driven to the end.
- **[Distributed solving](/research/build/concepts/distributed-solving)**.
...
- **[Quantum approaches](/research/build/concepts/quantum)**. The list's oldest
...
- **[Parity arguments](/research/build/concepts/parity-arguments)**. Count
  ...
  and the trap.
- **[Solution counting](/research/build/concepts/solution-counting)**. Nobody
