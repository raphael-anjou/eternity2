---
title: "Quantum approaches: two speedups, honestly priced"
description: >-
...
([message 263](https://groups.io/g/eternity2/message/263)) — a joke, and the
first appearance of a figure that would haunt the list for nineteen years:
...
annealing on an Ising encoding — and both can be told honestly, with
...
[Grover's algorithm](https://arxiv.org/abs/quant-ph/9605043) is the honest
headline of quantum search. Given $N$ possibilities and a black-box test for
...
arithmetic itself — the one genuinely technical Grover exchange in the
archive. In October 2021, prompted by Akos's estimate that a full sweep of
the search space needs at minimum $3.4\times10^{40}$ operations, Peter
McGavin asked whether Grover could search that tree in
...
bookkeeping, and the ancillas that make the check reversible — thousands of
...
when the board is a perfect solution — and, pleasingly, low-lying excited
...
- **Couplings:** every cell's 1,024 candidate placements are mutually
  exclusive — that is $\binom{1024}{2} \approx 5\times10^{5}$ quadratic terms
...
"result" would not be a quantum result.) And behind the size wall stands a
...
the hope, and it remains — on this problem class — a hope, not a result.
...
| 2008 | various | Quantum listed among "other ways" (3995), doubted for interference (4032), wished for (4850), satirized — the "time-travelling quantum computer" (5413, 5442), joked about (5542), tied to P=NP musings (5629), listed with holographic and DNA computing (5736) | [3995](https://groups.io/g/eternity2/message/3995), [4032](https://groups.io/g/eternity2/message/4032), [4850](https://groups.io/g/eternity2/message/4850), [5413](https://groups.io/g/eternity2/message/5413), [5629](https://groups.io/g/eternity2/message/5629), [5736](https://groups.io/g/eternity2/message/5736) |
...
| 2022-07 | mulisak | "Let quantum computing save us!" — QAOA-on-exact-cover paper + cuQuantum; "convince Google/IBM/Microsoft... that this will make them famous" | [10791](https://groups.io/g/eternity2/message/10791) |
...
"quantum leap" — or physics asides unrelated to computing.) Summed up: three
technical moments in nineteen years — Max's 2009 armchair theorem, McGavin's
2021 square root, mulisak's 2026 qubit count — one unfinished D-Wave
embedding, and zero reported runs of anything, on any instance. The
...
annealer time is rentable by the minute, and the honest experiment is small:
...
Until someone does that, the honest scoreboard reads: two beautiful
