...
([message 10289](https://groups.io/g/eternity2/message/10289))
...
roughly $8.1 \times 10^9$ pairs still undecided — and hiding among the
...
the pair space — and no way to guess at the rest without risking one of the
32,000 that must survive. Learned constraints about E2 are real assets — they are just being
