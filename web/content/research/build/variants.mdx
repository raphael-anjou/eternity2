...
metaDescription: "Every Eternity II that isn't the real 256-piece puzzle: the TopCoder Marathon variant, Takahashi's unverified 468, McGavin's unframed 480/480 that isn't a solution, mixed donor-set boards, and the no-starter $1000 challenge, all held in a claim quarantine, out of the records table."
kind: reference
order: 21
...
strict five-clue line (best known: 465) is tracked separately because it
...
2. **Name the rules regime.** Framed with grey edges on the rim?
   Starter-only (the 467→470 record line), strict five-clue (the 465
