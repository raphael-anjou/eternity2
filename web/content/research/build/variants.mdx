...
strict five-clue line (best known: 460) is tracked separately because it
...
McGavin's 10×10 benchmark solve: Dima reported that "467 has been broken
in 2009" — Naohiro Takahashi (chokudai), a top competitive programmer, had
tweeted a 468 — while stating plainly that he had never seen the solution
...
method would beat everything in Verhaard's arsenal
...
No resolution ever appeared in the archive. So the claim's honest status,
told in full: *if* the 468 was on the TopCoder variant, it is
rule-incomparable with Verhaard's 467; *if* it was on the real pieces, no
board was ever produced. Either way it stays out of the records table —
...
Asked the inevitable question — so you have solved Eternity 2? — McGavin
...
[11170](https://groups.io/g/eternity2/message/11170)). These are honest
constructions, clearly labelled by their makers, and they are the reason
the records table carries a "variant" badge on its 2023 row. The full
story of the donor sets — what the clue puzzles were, and how their pieces
ended up in these boards — is on
[the clue puzzles page](/research/build/clue-puzzles).

### The no-starter variant — the $1000 challenge
...
September ([msg 8922](https://groups.io/g/eternity2/message/8922)) — the
first post-contest cash on the table. McGavin immediately quantified what
the relaxation buys: an estimated **1.1527 × 10⁷ solutions without the
starter constraint versus 14,702 with it** — 784 times more needles — yet
the expected backtracker cost per solution barely moves (9.2766 × 10⁴²
...
*board or it didn't happen*: an honestly reported software popup, once
...
met with the other standard challenge: prove it by solving Brendan's
hint-free 10×10 benchmark
...
Vautrin episode shows the same machinery clearing an honest mistake in
four days.
...
2. **Name the rules regime.** Framed with grey edges on the rim?
   Starter-only (the 467→470 record line), strict five-clue (the 460
