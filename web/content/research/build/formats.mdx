...
metaDescription: "The byte-level spec for every Eternity II board format: board_edges, board_pieces, e2pieces.txt, CSV, site JSON and the viewer URLs, and how each encodes the border."
kind: reference
order: 8
group: Start here
