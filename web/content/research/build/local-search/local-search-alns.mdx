...
metaDescription: "Adaptive large-neighborhood search (ALNS) on Eternity II: destroy part of a board, rebuild the hole smarter, and let the algorithm learn which demolitions pay. This project's most reliable polisher — it lifts beam builds to record-class boards — yet it hits a hard wall it can never cross."
kind: concept
order: 60
group: Local search
updated: 2026-07-02
