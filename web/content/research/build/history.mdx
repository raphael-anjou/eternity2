...
description: >-
  ...
  every event sourced to its original message. Part I of a growing chronicle.
kind: reference
order: 35
updated: 2026-07-02
topics: [records]
...
([msg 384](https://groups.io/g/eternity2/message/384)). The earliest
...
reports arrived in December 2005 — Monckton promising the sequel would need
"the lifetime of the Universe" while co-designer Oliver Riordan said
...
([msg 35](https://groups.io/g/eternity2/message/35)) — a computer that, a
...
([msg 1054](https://groups.io/g/eternity2/message/1054)), confirmed the real
parameters — 5 border colours, 17 interior colours, the group's worst-case
scenario ([msg 977](https://groups.io/g/eternity2/message/977)) — and, after
"a nice chat to Mr Monckton", published the first solution-count estimate
for the real piece set: roughly 5,930 solutions with the mandatory clue,
against Monckton's own figure of about 5 million
...
A week into August, the puzzle's inventor arrived in person — to disqualify
someone. Posting from an unverifiable Yahoo address, Christopher Monckton
declared he held copyright on the piece designs and that his "web-trawling
software" had flagged Brendan Owen's website: Owen, who had been aiming for
the lesser prize, was out
([msg 1342](https://groups.io/g/eternity2/message/1342),
[msg 1352](https://groups.io/g/eternity2/message/1352)). It later emerged
...
The theory came fast after that. kubzpa proved by a parity argument that a
score of exactly 479 — one mismatched edge — is impossible
...
wanted the hardest possible 16×16 — flat distribution, about one expected
solution — the interior colour count should be (196! · 4^196)^(1/392) ≈
...
Theory was kept honest by a benchmark culture. Angel de Vicente — Txibilis —
built the standard suite of E2-like test boards
([msg 1610](https://groups.io/g/eternity2/message/1610)), and a duel began:
Txibilis's hand-designed fill orders against the automated
strategy-optimizer of doc_s_smith, driving full-search node counts down by
orders of magnitude — 89,794 nodes on one benchmark, answered within two
days by 85,729 ([msg 2896](https://groups.io/g/eternity2/message/2896),
...
eternity2.net, a BOINC-based distributed solver, launched with the puzzle in
July 2007 ([msg 756](https://groups.io/g/eternity2/message/756)) and had
1,300 members within a month — 160 of them in the USA, where the puzzle had
not even been released
([msg 2122](https://groups.io/g/eternity2/message/2122)). The project
...
over 10^19 CPU operations, best scores in the mid-460s — and his verdict
that a brute-force solution "was always clearly going to be impossible"
...
not ([msg 3663](https://groups.io/g/eternity2/message/3663)). The project's
...
"whilst all parties were out of the room" and vaulted
([msg 4177](https://groups.io/g/eternity2/message/4177)).

The exact-methods flank fared no better. A published SAT encoding of the
...
([msg 5767](https://groups.io/g/eternity2/message/5767)). Verhaard would
...
Then, on 22 September 2008, Verhaard published his solver for anyone to run
...
[msg 5958](https://groups.io/g/eternity2/message/5958)). The list was never
only a solver bench.
...
there would be no further clue puzzles, which most of the list welcomed as
keeping the challenge pure
([msg 6381](https://groups.io/g/eternity2/message/6381)). And Verhaard
casually settled a seventeen-month-old theorem: 479 *is* reachable — flip a
border piece whose two border edges share a colour in a 480 solution. The
2007 parity proof had missed the outward-facing border edges, which the
score never counts ([msg 6317](https://groups.io/g/eternity2/message/6317)).
Even the community's cleanest impossibility result had a loophole; the
puzzle, unsolved, kept all of its.

## To be continued

<Callout kind="note" title="Part I of a growing chronicle">
  This page is synthesized from the community archive in chronological
  windows, and the mining continues past February 2009. Later parts will
  pick up exactly where this one stops — the Hungarian "we solved it" rumor
  left hanging ([msg 6546](https://groups.io/g/eternity2/message/6546)), the
  edge-slipping theory race
  ([msg 6408](https://groups.io/g/eternity2/message/6408)), and the long
  climb toward the modern [record boards](/research/records).
</Callout>
