...
metaDescription: "Quantum approaches to Eternity II: Grover's quadratic speedup and QUBO annealing, the arithmetic against its real numbers, and 19 years of talk, zero runs."
kind: concept
order: 210
group: GPU & hardware
updated: 2026-07-02
...
<Callout kind="note" title="Quantum as a lens, not a tool">
  ...
  every hardware story on this wiki ([FPGA](/research/build/hardware/fpga-solving),
  [GPU](/research/build/hardware/gpu-solving), clusters) only divides by a
