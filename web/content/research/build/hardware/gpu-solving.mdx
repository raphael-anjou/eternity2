...
description: >-
  ...
  genuinely shine.
metaDescription: "GPU solving for Eternity II: why divergent branching and per-thread state defeat the parallel promise, and the one workload where GPUs genuinely shine."
kind: concept
order: 140
group: GPU & hardware
updated: 2026-07-02
...
[distributed computing](/research/build/faster/distributed-solving), not
...
conclusion covered [FPGAs](/research/build/hardware/fpga-solving) with the
...
[McGavin's](/research/lab/experiments/peter-mcgavin/backtracker) generated C on the newest
