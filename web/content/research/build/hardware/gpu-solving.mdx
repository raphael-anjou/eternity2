...
description: >-
  ...
  genuinely shine.
metaDescription: "GPU solving for Eternity II: eighteen years of community attempts showed divergent branching and per-thread state defeat the parallel promise, since the placement loop was already memory-bound on CPUs. But GPUs do shine at exhaustive verification and enumeration."
kind: concept
order: 140
group: GPU & hardware
updated: 2026-07-02
...
sources:
  ...
  - label: "The payoff: 9×9 set 1 exhaustively re-verified in 25h24m (groups.io message 9822, 2018)"
  ...
  - label: "Barr's rented RTX 4090: 3.17B placements/s on a 10×10, memory-limited on the full puzzle (groups.io message 11598, 2025)"
...
| Adam Miles (2020) | unannounced high-end GPU | Rewrite with "quite a bit more speed"; explicit that the full 16×16 stays out of reach | [9994](https://groups.io/g/eternity2/message/9994), [9996](https://groups.io/g/eternity2/message/9996), [9998](https://groups.io/g/eternity2/message/9998) |
