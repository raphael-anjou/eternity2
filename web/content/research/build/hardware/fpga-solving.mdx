---
title: "FPGA solving: mapped but never driven"
description: >-
  ...
  placements per second per chip, and ran a prototype on real silicon. Then
  the road was never driven to the end. The complete record, and why.
metaDescription: "FPGA solving for Eternity II: Michael Field's silicon prototype projected 5 billion placements/sec/chip, but the road was mapped, never driven."
kind: concept
order: 145
group: GPU & hardware
updated: 2026-07-02
...
The [GPU page](/research/build/hardware/gpu-solving) ends at a wall: an
...
[GPU page](/research/build/hardware/gpu-solving)): parallel searchers either
...
[solver-engineering page](/research/build/faster/solver-engineering),
...
against the [GPU page's](/research/build/hardware/gpu-solving) fatal ">8 KB
...
- **Mar 1: real silicon.** Arnaud Carré had supplied a 16x16, 29-colour
  ...
  ([message 9236](https://groups.io/g/eternity2/message/9236)). Two days later
...
[solver-engineering ledger](/research/build/faster/solver-engineering)
...
| Mike Field | 2014 | Built and measured: hyper-pipelined prototype walks a 16x16 benchmark on silicon; 1 thread ≈ 1/8 i7 core (his own correction of an initial 1/3) | [9237](https://groups.io/g/eternity2/message/9237) |
...
[GPU page](/research/build/hardware/gpu-solving) arrives at:
