...
description: >-
  ...
  correctement.
metaDescription: "Tous les Eternity II qui ne sont pas le vrai puzzle à 256 pièces : la variante de TopCoder, le 468 non vérifié de Takahashi, le 480/480 sans cadre de McGavin qui n'est pas une solution, les plateaux à jeux mélangés et le défi sans amorce à 1000 $, tenus en quarantaine, hors des records."
kind: reference
order: 21
...
la lignée stricte à cinq indices (meilleure connue : 465) est suivie
...
2. **Nommez le régime de règles.** Encadré avec les bords gris sur le
   ...
   stricts (la lignée du 465), sans amorce (le défi à 1000 $), ou sans
